...
{
    internal class DeathScreen : Screen
    {
        private Text _text;
        ...
        public override void Start(Core core)
        {
            ...
            Settings.BackgroundFill = Colour.Crimson;

            AudioManager.Instance.StopBGM();
            AudioManager.Instance.PlayBGM("DeathScreen");

            //sets a text on screen with the colour white and sets scale increase by 2
            //also has changed the font type
            _text = new Text("You Died", Colour.White);
            AddText(_text, 720, 150);
        ...
        public override void Update(float deltaTime)
        {
            ...
            _text.SetColour(0, 0, 0, (int)_transparent);
            if (_transparent != 255)
            {
            ...
            _enter.SetColour(0, 0, 0, (int)_transparent3);
            ...
            _exit.SetColour(0, 0, 0, (int)_transparent4);
        ...
        private void InputCheck()
        {
            ...
            else if (GameInput.IsKeyPressed("Esc"))
            {
                ...
                //a sound clip is also played when esc is pressed
                AudioManager.Instance.PlaySFX("click");
                Core.EndGame();
                Core.CloseGame();
            }
